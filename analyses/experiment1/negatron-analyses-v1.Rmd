...
qplot(context, m, group = sentence.type,
  ...
  annotate("text", x=3.5, y=.85, label="True Positive", color="grey", size=7) + 
  annotate("text", x=2.50, y=.25, label="True Negative", color="black", size=7) + 
...
qplot(context, -log(m), group = sentence.type,
  ...
  xlab("Context Condition") + 
  scale_colour_grey(guide=FALSE) + 
  annotate("text", x=1.75, y=.40, label="True Positive", color="grey", size=7) + 
  annotate("text", x=2, y=4, label="True Negative", color="black", size=7) + 
  theme_classic(base_size = 25)
```
...
ggplot(data.ms, aes(color=sentence.type, y=rt, x=surprisal)) + 
  ...
  annotate("text", x=.75, y=1525, label="R^2 == .94", parse=TRUE, color="black", size=3.5) + 
  annotate("text", x=3.9, y=1725, label="R^2 == .95", parse=TRUE, color="black", size=3.5) + 
