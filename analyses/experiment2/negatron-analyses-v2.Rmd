...
l.genders <- d.listeners %>%
  ...
  summarize(n = n.unique(subid))
```
n = `r n.unique(d.listeners$subid)` participants in listener condition; n = `r filter(l.genders, gender == "F")$n` female and n = `r filter(l.genders, gender == "M")$n`male; n = `r filter(l.genders, gender == "Decline")$n` participants declined to state their gender.
...
What are people talking about in the 0/4 context? This is addressed in the General Discussion of the paper.

```{r nothing_context, fig.width=8, fig.height=6}
