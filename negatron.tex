...
\begin{figure}
\begin{center} 
\includegraphics[height=3in]{figures/v7_bargraph.pdf}
...
\begin{figure}
\begin{center} 
\includegraphics[width=6in]{figures/v9_linegraph.pdf}
...
\begin{figure}
\begin{center} 
\includegraphics[width=6in]{figures/v18_linegraph.pdf}
\caption{\label{fig:addition_subs} Reaction times for each trial type, across different conditions.}
\end{center} 
\end{figure}
...
\begin{figure}
\begin{center} 
\includegraphics[width=6in]{figures/meta_diffscores.pdf}
...
\begin{figure}
\begin{center} 
\includegraphics[width=6in]{figures/meta_TNvTP.pdf}
